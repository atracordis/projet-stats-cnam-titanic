...
Le projet est disponible sous un formal lisible (notebook Python) à l'url [github](https://github.com/atracordis/projet-stats-cnam-titanic/blob/main/Python_Projet_STA201_Wajd_Meskini_Kaouther_Makhlouf.ipynb
)
